...
namespace OshawaBookStore.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName,PurchaseDate")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,PurchaseDate")] Customer customer)
        {
            if (id != customer.ID)
            {
                return NotFound();
